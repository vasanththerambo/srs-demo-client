...
const ThemeContextProvider = (props) => {
  ...
  const [sidebarLayout, setSidebarLayout] = useState({ value: "vertical", label: "Vertical",});
	...
	const [primaryColor, setPrimaryColor] = useState("color_5");
	const [navigationHader, setNavigationHader] = useState("color_5");
	const [haderColor, setHaderColor] = useState("color_5");
	const [sidebarColor, setSidebarColor] = useState("color_5");
...
//setAttr.value = themeSettings.headerBg;
	changeHaderColor(themeSettings.headerBg);
