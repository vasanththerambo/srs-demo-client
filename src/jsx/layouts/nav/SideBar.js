        ...
        <MM className="metismenu" id="menu">
          ...
          <li className={`${profiles.includes(path) ? "mm-active" : ""}`}>
				    <Link className="has-arrow ai-icon" to="#" >
					    <i className="flaticon-045-heart"></i><span className="nav-text">View Profiles</span>
				    </Link>
				    <ul >
				      <li><Link className={`${path === "profiles-matching" ? "mm-active" : ""}`} to="/profiles-matching">Matching Profiles</Link></li>
				      <li><Link className={`${path === "uc-nestable" ? "mm-active" : ""}`} to="#">Interests Sent</Link></li>
				      <li><Link className={`${path === "uc-noui-slider" ? "mm-active" : ""}`} to="#">Interest Received</Link></li>
