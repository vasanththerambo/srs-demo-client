...
const Demo5 = () => {
	const { 
		changeBackground,
		changeSideBarPostion,changeSideBarLayout,
	...
	useEffect(() => {
		...
		changeSidebarColor("color_3");
		changeSideBarPostion({ value: "static", label: "Static" });
		changePrimaryColor("color_3");
	}, [changeBackground,changeSideBarLayout,changeSidebarColor,changeSideBarPostion,changePrimaryColor]);
