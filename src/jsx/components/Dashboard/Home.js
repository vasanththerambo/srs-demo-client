...
const Home = (props) => {
	...
	useEffect(()=>{
		...
		else if(!userProfile.advanceProfileStatus){
	...
	useEffect(() => {
		...
		else if (!userProfile.accountStatus) {
			setaccountStatus(false)
		}
		else {
					...
					<div className="card gradient-1 card-bx">
						<div className="card-body d-flex align-items-center">
							<div className="me-auto text-white">
								...
								<span className="fs-18">Interests</span>
							</div>
					...
					<div className="card gradient-2 card-bx">
						<div className="card-body d-flex align-items-center">
							<div className="me-auto text-white">
								...
								<span className="fs-18">Messages</span>
							</div>
							<svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div className="card gradient-3 card-bx">
						<div className="card-body d-flex align-items-center">
							<div className="me-auto text-white">
								...
								<span className="fs-18">Requests</span>
							</div>
							<svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div className="card gradient-4 card-bx">
						<div className="card-body d-flex align-items-center">
							<div className="me-auto text-white">
								...
								<span className="fs-18">Reminders</span>
							</div>
							...
							<div className="card text-center">
								<div className="card-body">
									<div id="radialChart" className="radialChart">
										{ <RadialDount profileCompletion={profileCompletion}/>}
									</div>
									<h2>{profileCompletion} %</h2>
									<span className="fs-16 text-black">Profile Completion</span>
									<div style={{marginTop:"20px"}}>
										{profileCompletion==="0" ? <div><h4 className="text-primary">Your Profile is empty</h4><Link to="/form-add-basic-profile" > Click Here to Fill up Your Profile </Link> </div>:""}
				 ...
				 <div className="card">
					...
					<div className="card-body">
							<div style={{marginTop:"0px"}}>
										{!accountStatus? <div><h4 className="text-primary">Your Account is inactive</h4><Link to="/activate-account" > Click Here to activate your account </Link> </div>: <div> <h4 className='text-success'>Your account is active</h4> </div>}
										
							</div>
					</div>	
					<div className="card-header border-0 pb-0">
						<h4 className="mb-0">Profile Status</h4>
					</div>
					<div className="card-body">
									<div className="progress mb-4" style={{height:"13px"}}>
										<div className="progress-bar gradient-5 progress-animated" style={{width: "55%", height:"13px"}} >
											<span className="sr-only">5 Profile Views</span>
										</div>
									</div>
									<div className="progress mb-4" style={{height:"13px"}}>
										<div className="progress-bar gradient-6 progress-animated" style={{width: "55%", height:"13px"}}>
											<span className="sr-only">13 New Matches</span>
										</div>
									</div>
									<div className="progress default-progress" style={{height:"13px"}}>
										<div className="progress-bar gradient-7 progress-animated" style={{width: "55%", height:"13px"}}>
											<span className="sr-only">19 Profiles Visited By You</span>
										</div>
									</div>
									<div className="d-flex mt-4 progress-bar-legend align-items-center justify-content-between">
										<div className="d-flex">
											...
											<div>
												<p className="status">Profile Views</p>
										...
										<div className="d-flex">
											...
											<div>
												<p className="status">New Matches</p>
										...
										<div className="d-flex">
											...
											<div>
												<p className="status">Your Visit</p>
												<span className="result">19</span>
											</div>
										</div>
									</div>
						</div>
