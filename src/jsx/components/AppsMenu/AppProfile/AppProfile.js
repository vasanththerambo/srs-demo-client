...
// import {setUserProfile, clearUserProfile} from "../../../../store/actions/UserProfileActions"
...
useEffect(() => {
  ...
  const {_id,firstName,lastName,email,dob,religion,caste,height,weight,bloodGroup,bodytype,complexion,languages,mothertongue,
	physicalStatus} = userProfile;
...
//   axios.defaults.headers.common["Authorization"] = `Bearer ${token}`;
	...
	const backendPath = `${Constants.url_postProfile}/${_id}`;
  ...
  const handleDelete=()=>{
	axios.delete(backendPath).then((response)=>{
		dispatch(UserProfileActions.reset());
  ...
  useEffect(()=>{
	if(userProfile.image){
		...
		setprofilePic(userProfile.image);
	}
	else{
          ...
          <div className="card">
            ...
            <Card.Body>
                ...
                >
                  ...
                  >
                   <Link to ="/form-edit-basic-profile"> click here to edit your basic profile </Link>
                  </Badge>
			...
			<Card.Body>
                ...
                >
                  ...
                  <Badge
                    ...
                    className="badge-sm light ms-1"
                  >
                    <Link to="/form-edit-advance-info"> click here to edit your advanced profile </Link> 
                  </Badge>
