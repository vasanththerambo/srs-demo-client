...
/// Profile List
import ProfilesMatching from "./components/AppsMenu/Profiles/ProfileList/ProfilesMatching";
import ProfileDetail from "./components/AppsMenu/Profiles/profileDetail";

/// Account Details
import ActivateAccount from "./components/AppsMenu/Account/ActivateAccount";
import AccountStatus from "./components/AppsMenu/Account/AccountStatus";
...
import FormBasicProfileAdd from "./components/Forms/formBasicProfileAdd/formBasicProfileAdd";
import FormBasicProfileEdit from "./components/Forms/formBasicProfileEdit/formBasicProfileEdit";
import FormAdvanceProfileAdd from "./components/Forms/formAdvanceProfileAdd/formAdvanceProfileAdd";
import FormAdvanceProfileEdit from "./components/Forms/formAdvanceProfileEdit/formAdvanceProfileEdit";
...
const Markup = () => {
  ...
  const routes = [
   ...
   // { url: "theme6", component: Demo6 },
    ...
    /// Profiles
    { url: "profiles-matching", component: ProfilesMatching },
    { url: "profile-detail/:id", component: ProfileDetail },
    /// Account Details
    { url: "activate-account", component: ActivateAccount },
    {url:"account-status" ,component:AccountStatus},
    ...
    { url: "form-add-basic-profile" , component: FormBasicProfileAdd },
    { url: "form-edit-basic-profile", component:FormBasicProfileEdit},
    { url: "form-add-advance-info", component:FormAdvanceProfileAdd},
    { url: "form-edit-advance-info", component:FormAdvanceProfileEdit},
